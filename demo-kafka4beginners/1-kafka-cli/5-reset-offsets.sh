...
kafka-consumer-groups.sh --bootstrap-server localhost:19092 --group my-first-application --reset-offsets --to-earliest --topic four_topic --dry-run
...
kafka-consumer-groups.sh --bootstrap-server localhost:19092 --group my-first-application --reset-offsets --to-earliest --topic four_topic --execute
