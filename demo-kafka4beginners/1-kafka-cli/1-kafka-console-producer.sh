...
#not working
# kafka-console-producer --bootstrap-server localhost:19092 --topic four_topic --producer-property partitioner.class=org.apache.kafka.clients.producer.RoudRobinPartitioner
